...
namespace INFOGR2024Template
{
    public class OpenTKApp : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            Scene scene = new();
            app = new MyApplication(screen, scene);
            ...
            {   // setting up a Modern OpenGL pipeline takes a lot of code
                ...
                int viewPortUniformLocation = GL.GetUniformLocation(programID, "ViewportSize");
                GL.Uniform2(viewPortUniformLocation, ClientSize.X, ClientSize.Y);
